/*! For license information please see 267.5b0fae4a.chunk.js.LICENSE.txt */
  ...
  [267],
  {
    57832: (e, t, r) => {
      ...
      class p {
        constructor(e) {
          ...
          const _ = (0, i.isMobileWeb)(),
            b =
              e.uiConstructor ||
              ((e) =>
                _ ? new l.MobileRelayUI(e) : new d.WalletLinkRelayUI(e)),
            y = {
              linkAPIUrl: a,
        ...
        setAppInfo(e, t) {
          var r;
          (this._appName = e || "DApp"), (this._appLogoUrl = "/favicon.png");
          ...
          if (
            ...
            (r.code = t.code),
              t.message && "string" === typeof t.message
                ? ((r.message = t.message), l(t, "data") && (r.data = t.data))
                : ((r.message = i(r.code)),
                  (r.data = {
                    originalError: c(e),
                  }));
    ...
    10723: function (e, t, r) {
      ...
      function p(e) {
        ...
        if ("string" === typeof e) {
          ...
          if (c.test(r)) return (0, o.HexString)(t ? `0x${r}` : r);
        }
      ...
      function m(e) {
        ...
        if ("string" === typeof e) {
          ...
          if (f(e))
            return (0, o.IntNumber)(new s.default(g(e, !1), 16).toNumber());
        }
        throw i.standardErrors.rpc.invalidParams(
      ...
      (t.randomBytesHex = function (e) {
        ...
        (t.hexStringFromIntNumber = function (e) {
          return (0, o.HexString)(`0x${new s.default(e).toString(16)}`);
        }),
        (t.has0xPrefix = u),
        (t.strip0x = d),
        (t.prepend0x = h),
        ...
        (t.ensureAddressString = function (e) {
          if ("string" === typeof e) {
            const t = d(e).toLowerCase();
            if (f(t) && 40 === t.length) return (0, o.AddressString)(h(t));
          }
          throw i.standardErrors.rpc.invalidParams(
        ...
        (t.ensureBN = function (e) {
          if (null !== e && (s.default.isBN(e) || _(e)))
            return new s.default(e.toString(10), 10);
          if ("number" === typeof e) return new s.default(m(e));
          if ("string" === typeof e) {
            if (a.test(e)) return new s.default(e, 10);
            if (f(e)) return new s.default(g(e, !1), 16);
          }
          throw i.standardErrors.rpc.invalidParams(
            `Not an integer: ${String(e)}`
          );
        ...
        (t.getLocation = function () {
          try {
            return b() && window.top ? window.top.location : window.location;
          } catch (e) {
      ...
      class b extends i.EventEmitter {
        constructor(e) {
          ...
          const n = this.getChainId(),
            s = (0, a.prepend0x)(n.toString(16));
          this.emit("connect", {
            chainIdStr: s,
          });
          const i = this._storage.getItem(l.LOCAL_STORAGE_ADDRESSES_KEY);
          if (i) {
            const e = i.split(" ");
            "" !== e[0] &&
        ...
        async addEthereumChain(e, t, r, n, s, i) {
          ...
          const h = await l.addEthereumChain(e.toString(), t, s, r, n, i)
            .promise;
          return (
            ...
            !0 ===
              (null === (c = h.result) || void 0 === c ? void 0 : c.isApproved))
          );
        }
        ...
        _prepareTransactionParams(e) {
          ...
          return {
            ...
            weiValue:
              null != e.value ? (0, a.ensureBN)(e.value) : new s.default(0),
        ...
        async _eth_signTransaction(e) {
          ...
          try {
            ...
            if ((0, d.isErrorResponse)(r)) throw new Error(r.errorMessage);
            return {
              jsonrpc: "2.0",
              id: 0,
              result: r.result,
        ...
        async _eth_sendRawTransaction(e) {
          ...
          if ((0, d.isErrorResponse)(n)) throw new Error(n.errorMessage);
          return {
            jsonrpc: "2.0",
            id: 0,
            result: n.result,
        ...
        async _eth_signTypedData_v1(e) {
          ...
          const n = h.default.hashForSignTypedDataLegacy({
              data: t,
            }),
        ...
        async _eth_signTypedData_v3(e) {
          ...
          this._ensureKnownAddress(t);
          const n = h.default.hashForSignTypedData_v3({
              data: r,
            }),
        ...
        async _eth_signTypedData_v4(e) {
          ...
          const t = (0, a.ensureAddressString)(e[0]),
            r = (0, a.ensureParsedJSONObject)(e[1]);
          this._ensureKnownAddress(t);
          const n = h.default.hashForSignTypedData_v4({
              data: r,
            }),
            s = JSON.stringify(r, null, 2);
          return this._signEthereumMessage(n, t, !1, s);
        ...
        async _wallet_addEthereumChain(e) {
          ...
          const i = e[0];
          if (
            0 === (null === (t = i.rpcUrls) || void 0 === t ? void 0 : t.length)
          )
            return {
              jsonrpc: "2.0",
              id: 0,
    ...
    93304: (e, t, r) => {
      ...
      function c(e) {
        ...
        if ((0, s.isHexString)(e)) return (0, s.intNumberFromHexString)(e);
        throw new Error(`Invalid block option: ${String(e)}`);
      }

      function l(e) {
        return "latest" === e ? e : (0, s.hexStringFromIntNumber)(e);
      }
      ...
      (t.FilterPolyfill = class {
        ...
        uninstallFilter(e) {
          const t = (0, s.intNumberFromHexString)(e);
          return (
        ...
        async getLogFilterChanges(e) {
          ...
          if (r > o) return d();
          if (r > Number(t.toBlock)) return d();
          ...
          if (Array.isArray(l.result)) {
            const t = l.result.map((e) =>
                (0, s.intNumberFromHexString)(e.blockNumber || "0x0")
              ),
              i = Math.max(...t);
            if (i && i > r) {
              const t = (0, n.IntNumber)(i + 1);
              console.info(
        ...
        async _getCurrentBlockHeight() {
          ...
          return (0, s.intNumberFromHexString)((0, s.ensureHexString)(e));
        }
        async getBlockHashByNumber(e) {
          const t = await this.sendAsyncPromise(
            Object.assign(Object.assign({}, i), {
              method: "eth_getBlockByNumber",
              params: [(0, s.hexStringFromIntNumber)(e), !1],
            })
          );
          return t.result && "string" === typeof t.result.hash
            ? (0, s.ensureHexString)(t.result.hash)
            : null;
        }
      }),
        (t.filterFromParam = o);
    ...
    3181: (e, t, r) => {
      ...
      t.SubscriptionManager = class {
        ...
        async handleRequest(e) {
          const t = {};
          return await this.subscriptionMiddleware(e, t, i, i), t;
        }
        destroy() {
        ...
        async makeEthereumJSONRPCRequest(e, t) {
          ...
          return window
            ...
            .then((t) => {
              ...
              const r = t,
                { error: s } = r;
              if (s) throw (0, n.serializeError)(s, e.method);
              return r;
            });
        }
      };
    ...
    4961: (e, t, r) => {
      ...
      class h extends a.RelayAbstract {
            ...
            (this.linkedUpdated = (e) => {
              ...
              if (
                ...
                if ("" !== n[0] && !e && this.session.linked && !s) {
                  ...
                  null === (t = this.diagnostic) ||
                    void 0 === t ||
                    t.log(o.EVENTS.UNLINKED_ERROR_STATE, {
                      sessionIdHash: e,
                    });
                }
              }
            ...
            (this.accountUpdated = (e) => {
              this.accountsCallback && this.accountsCallback([e]),
                h.accountRequestCallbackIds.size > 0 &&
                  (Array.from(h.accountRequestCallbackIds.values()).forEach(
                    (t) => {
                      const r = {
                        type: "WEB3_RESPONSE",
                        id: t,
        ...
        signEthereumMessage(e, t, r, n) {
          return this.sendRequest({
            ...
            params: {
              message: (0, i.hexStringFromBuffer)(e, !0),
              address: t,
              addPrefix: r,
        ...
        ethereumAddressFromSignedMessage(e, t, r) {
          return this.sendRequest({
            ...
            params: {
              message: (0, i.hexStringFromBuffer)(e, !0),
              signature: (0, i.hexStringFromBuffer)(t, !0),
              addPrefix: r,
            },
          });
        }
        signEthereumTransaction(e) {
          return this.sendRequest({
            ...
            params: {
              ...
              weiValue: (0, i.bigIntStringFromBN)(e.weiValue),
              data: (0, i.hexStringFromBuffer)(e.data, !0),
              nonce: e.nonce,
              gasPriceInWei: e.gasPriceInWei
                ? (0, i.bigIntStringFromBN)(e.gasPriceInWei)
                : null,
              ...
              maxPriorityFeePerGas: e.gasPriceInWei
                ...
                : null,
              gasLimit: e.gasLimit
                ? (0, i.bigIntStringFromBN)(e.gasLimit)
                : null,
              chainId: e.chainId,
              shouldSubmit: !1,
            },
          ...
          return this.sendRequest({
            ...
            params: {
              ...
              maxFeePerGas: e.maxFeePerGas
                ? (0, i.bigIntStringFromBN)(e.maxFeePerGas)
                : null,
              maxPriorityFeePerGas: e.maxPriorityFeePerGas
                ? (0, i.bigIntStringFromBN)(e.maxPriorityFeePerGas)
                : null,
              gasLimit: e.gasLimit
                ? (0, i.bigIntStringFromBN)(e.gasLimit)
                : null,
        ...
        submitEthereumTransaction(e, t) {
          return this.sendRequest({
            ...
            params: {
              signedTransaction: (0, i.hexStringFromBuffer)(e, !0),
              chainId: t,
            },
          });
        }
        ...
        handleWeb3ResponseMessage(e) {
          ...
          if (
            ...
            return (
              h.accountRequestCallbackIds.forEach((t) =>
                this.invokeCallback(
        ...
        handleErrorResponse(e, t, r, s) {
          var i;
          const o =
            null !== (i = null === r || void 0 === r ? void 0 : r.message) &&
            void 0 !== i
              ? i
              : (0, n.getMessageFromCode)(s);
          this.handleWeb3ResponseMessage({
            type: "WEB3_RESPONSE",
            id: e,
            response: {
          ...
          return {
            ...
            promise: new Promise((i, d) => {
              this.relayEventManager.callbacks.set(l, (e) => {
                if (
                  (null === c || void 0 === c || c(), (0, u.isErrorResponse)(e))
                )
      ...
      (t.WalletLinkRelay = h), (h.accountRequestCallbackIds = new Set());
    },
    8259: (e, t, r) => {
      "use strict";
      Object.defineProperty(t, "__esModule", {
          ...
          (this.destroyed = !1),
            ...
            (this.handleDestroyed = (e) => {
              ...
              "1" === e &&
                ...
                null === (r = this.diagnostic) ||
                  void 0 === r ||
                  r.log(i.EVENTS.METADATA_DESTROYED, {
            ...
            (this.session = t),
            (this.cipher = new s.Cipher(t.secret)),
            (this.diagnostic = d),
            (this.listener = u);
          const f = new l.WalletLinkWebSocket(`${r}/rpc`, h);
          f.setConnectionStateListener(async (e) => {
            var r;
            null === (r = this.diagnostic) ||
              void 0 === r ||
              r.log(i.EVENTS.CONNECTED_STATE_CHANGE, {
                state: e,
            ...
            f.setIncomingDataListener((e) => {
              ...
              switch (e.type) {
                ...
                case "SessionConfigUpdated":
                  null === (n = this.diagnostic) ||
                    void 0 === n ||
                    n.log(i.EVENTS.SESSION_CONFIG_RECEIVED, {
                      sessionIdHash: a.Session.hash(t.id),
                      metadata_keys:
              ...
              void 0 !== e.id &&
                (null === (s = this.requestResolutions.get(e.id)) ||
                  void 0 === s ||
                  s(e));
            }),
            (this.ws = f),
            (this.http = new c.WalletLinkHTTP(r, t.id, t.key));
        }
        connect() {
          var e;
          ...
          null === (e = this.diagnostic) ||
            void 0 === e ||
            e.log(i.EVENTS.STARTED_CONNECTING, {
              sessionIdHash: a.Session.hash(this.session.id),
            }),
            this.ws.connect();
        }
    ...
    45936: function (e, t, r) {
      ...
      function b(e) {
        ...
        return (0, i.h)(
          "div",
          {
            className: (0, s.default)("-cbwsdk-connect-item", n),
          },
          (0, i.h)("div", null, (0, i.h)(l.CoinbaseWalletRound, null)),
          (0, i.h)(
            "div",
            {
        ...
        return (0, i.h)(
          ...
          (0, i.h)("div", {
            class: (0, s.default)(
              ...
              f,
              d && "-cbwsdk-connect-dialog-backdrop-hidden"
            ),
          }),
          (0, i.h)(
            "div",
            ...
            (0, i.h)(
              "div",
              {
                class: (0, s.default)(
                  ...
                  d && "-cbwsdk-connect-dialog-box-hidden"
                ),
              },
              e.connectDisabled
                ? null
                : (0, i.h)(a.ConnectContent, {
                    theme: f,
                    version: e.version,
        ...
        return (
          (0, i.useEffect)(() => {
            ...
            const s = new o.default({
              ...
              i = Buffer.from(s.svg(), "utf8").toString("base64");
            r(`data:image/svg+xml;base64,${i}`);
        ...
        return (0, i.h)(
          ...
          (0, i.h)(
            ...
            (0, i.h)(
              "div",
              {
                class: (0, s.default)("-cbwsdk-redirect-dialog-box", u),
              },
              (0, i.h)("p", null, t),
              (0, i.h)(
                "button",
    ...
    14256: function (e, t, r) {
      ...
      t.SnackbarInstance = (e) => {
        ...
        const [a, c] = (0, o.useState)(!0),
          [l, u] = (0, o.useState)(null !== t && void 0 !== t && t);
        (0, o.useEffect)(() => {
          const e = [
            window.setTimeout(() => {
              c(!1);
    ...
    10416: function (e, t, r) {
      ...
      t.TryExtensionContent = function (e) {
        ...
        const [r, n] = (0, o.useState)(!1),
          ...
          h = (0, o.useCallback)(() => {
            r ? window.location.reload() : (d(), n(!0));
          }, [d, r]);
        return (0, i.h)(
          "div",
          {
            class: (0, s.default)("-cbwsdk-try-extension", t),
          },
          ...
          (0, i.h)(
            ...
            (0, i.h)(
              "h3",
              {
                class: (0, s.default)("-cbwsdk-try-extension-heading", t),
              },
            ...
            (0, i.h)(
              ...
              (0, i.h)(
                "button",
                {
                  class: (0, s.default)("-cbwsdk-try-extension-cta", t),
                  onClick: h,
                },
                r ? "Refresh" : "Install"
              ),
    ...
    20494: (e, t, r) => {
      ...
      function u(e, t) {
        ...
        if ("bytes" === e)
          return (
            (t = new Buffer(t)),
            (d = Buffer.concat([u("uint256", t.length), t])),
            t.length % 32 !== 0 &&
              (d = Buffer.concat([d, n.zeros(32 - (t.length % 32))])),
            d
          );
        ...
        if (e.startsWith("ufixed")) {
          ...
          return u("uint256", i.mul(new s(2).pow(new s(r[1]))));
        }
        if (e.startsWith("fixed"))
          return (r = a(e)), u("int256", l(t).mul(new s(2).pow(new s(r[1]))));
      ...
      function h(e, t) {
        ...
        for (var r, s, a = [], c = 0; c < e.length; c++) {
          var u = i(e[c]),
            d = t[c];
          if ("bytes" === u) a.push(d);
          else if ("string" === u) a.push(new Buffer(d, "utf8"));
          else if ("bool" === u) a.push(new Buffer(d ? "01" : "00", "hex"));
          else if ("address" === u) a.push(n.setLength(d, 20));
          else if (u.startsWith("bytes")) {
            if ((r = o(u)) < 1 || r > 32)
              throw new Error("Invalid bytes<N> width: " + r);
            a.push(n.setLengthRight(d, r));
            ...
            a.push(s.toArrayLike(Buffer, "be", r / 8));
          } else {
            if (!u.startsWith("int"))
            ...
            a.push(s.toTwos(r).toArrayLike(Buffer, "be", r / 8));
          }
        }
        ...
        rawEncode: function (e, t) {
          ...
          for (var o in e) {
            var a = i(e[o]),
              c = u(a, t[o]);
            d(a)
              ? (r.push(u("uint256", s)), n.push(c), (s += c.length))
              : r.push(c);
          }
    ...
    48316: (e, t, r) => {
      const n = r(47198),
        ...
        o = {
                ...
                if (void 0 !== r[t])
                  return [
                    ...
                    null == o
                      ...
                      : n.keccak(this.encodeData(t, o, r, i)),
                  ];
                if (void 0 === o)
              ...
              for (const s of r[e]) {
                ...
                if (void 0 !== e)
                  if ("bytes" === s.type)
                    ...
                    o.push("bytes32"),
                      (e = n.keccak(this.encodeData(s.type, e, r, i))),
                      a.push(e);
                  else {
                    ...
                    o.push(s.type), a.push(e);
                  }
              }
            return s.rawEncode(o, a);
          },
          encodeType(e, t) {
            let r = "",
          ...
          sanitizeData(e) {
            const t = {};
            for (const r in i.properties) e[r] && (t[r] = e[r]);
            return (
              t.types &&
        ...
        hashForSignTypedDataLegacy: function (e) {
          return (function (e) {
            ...
            return s.soliditySHA3(
              ["bytes32", "bytes32"],
              [
                s.soliditySHA3(new Array(e.length).fill("string"), o),
                s.soliditySHA3(i, r),
              ]
            );
          })(e.data);
    ...
    86758: (e) => {
      ...
      (t.prototype = {
        ...
        (r.createData = function (e, t, n) {
          for (
            var s = v.getRSBlocks(e, t), i = new w(), o = 0;
            o < n.length;
            o++
          ) {
            var a = n[o];
          ...
          var c = 0;
          for (o = 0; o < s.length; o++) c += s[o].dataCount;
          ...
          for (
            ...
            (i.put(r.PAD0, 8), !(i.getLengthInBits() >= 8 * c));
      ...
      (y.prototype = {
        ...
        (v.getRSBlocks = function (e, t) {
          var r = v.getRsBlockTable(e, t);
          if (void 0 == r)
            throw new Error(
          ...
          for (var n = r.length / 3, s = [], i = 0; i < n; i++)
            for (
              var o = r[3 * i + 0], a = r[3 * i + 1], c = r[3 * i + 2], l = 0;
              l < o;
              l++
            )
              s.push(new v(a, c));
        ...
        (v.getRsBlockTable = function (e, t) {
          switch (t) {
            case s:
              return v.RS_BLOCK_TABLE[4 * (e - 1) + 0];
            case i:
              return v.RS_BLOCK_TABLE[4 * (e - 1) + 1];
            case o:
              return v.RS_BLOCK_TABLE[4 * (e - 1) + 2];
            case a:
              return v.RS_BLOCK_TABLE[4 * (e - 1) + 3];
            default:
              return;
          }
        }),
      ...
      function k(e) {
        ...
        var n = this.options.content,
          c = (function (e, t) {
            for (
              ...
              if (!a)
                throw new Error(
                  "Content too long: expected " + s + " but got " + r
                );
              switch (t) {
                case "L":
                  s = a[0];
        ...
        (this.qrcode = new r(c, l)), this.qrcode.addData(n), this.qrcode.make();
      }
      (k.prototype.svg = function (e) {
        ...
        for (
          var n = "undefined" == typeof t.pretty || !!t.pretty,
            ...
            l = o / (c + 2 * t.padding),
            u = a / (c + 2 * t.padding),
            d = "undefined" != typeof t.join && !!t.join,
    ...
    24398: (e, t, r) => {
      ...
      class i extends n.EventEmitter {
        emit(e) {
          ...
          if ("function" === typeof a) s(a, this, i);
          else {
            const e = a.length,
              t = (function (e) {
                const t = e.length,
            ...
            for (let r = 0; r < e; r += 1) s(t[r], this, i);
          }
          return !0;
        }
      }
    ...
    30604: (e, t, r) => {
      ...
      function a(e) {
        (0, n.assert)(o(e), "Value must be a Uint8Array.");
      }
      ...
      function u(e) {
        ...
        const r = (0, s.remove0x)(e).toLowerCase(),
          n = r.length % 2 === 0 ? r : `0${r}`,
          i = new Uint8Array(n.length / 2);
        for (let s = 0; s < i.length; s++) {
          const e = n.charCodeAt(2 * s),
            t = n.charCodeAt(2 * s + 1),
            r = e - (e < 58 ? 48 : 87),
            o = t - (t < 58 ? 48 : 87);
          i[s] = 16 * r + o;
        }
      ...
      function p(e) {
        ...
        if ("string" === typeof e) return e.startsWith("0x") ? u(e) : f(e);
        if (o(e)) return e;
      ...
      (t.isBytes = o),
        ...
        (t.signedBigIntToBytes = function (e, t) {
          ...
          for (let n = 0; n < s.length; n++)
            (s[n] = Number(BigInt.asUintN(8, r))), (r >>= BigInt(8));
          return s.reverse();
        }),
        (t.numberToBytes = h),
        (t.stringToBytes = f),
    ...
    77610: function (e, t) {
      ...
      var r,
        ...
        s =
          ...
          function (e, t, r, n, s) {
            ...
            return (
              "a" === n ? s.call(e, r) : s ? (s.value = r) : t.set(e, r), r
            );
          },
        i =
      ...
      class o {
        constructor(e) {
          r.set(this, void 0), s(this, r, new Map(e), "f"), Object.freeze(this);
        }
        get size() {
      ...
      class a {
        constructor(e) {
          n.set(this, void 0), s(this, n, new Set(e), "f"), Object.freeze(this);
        }
        get size() {
    ...
    86970: (e, t, r) => {
      ...
      (t.HexStruct = (0, n.pattern)((0, n.string)(), /^(?:0x)?[0-9a-f]+$/iu)),
        ...
        (t.assertIsHexString = function (e) {
          (0, s.assert)(i(e), "Value must be a hexadecimal string.");
        }),
    ...
    64897: (e, t, r) => {
      ...
      (t.UnsafeJsonStruct = (0, n.union)([
        ...
        (t.getJsonSize = function (e) {
          (0, s.assertStruct)(e, t.JsonStruct, "Invalid JSON value");
    ...
    66142: function (e, t, r) {
      ...
      const s = (0, n(r(10255)).default)("metamask");
    ...
    77974: (e, t, r) => {
      ...
      t.hexToBigInt = (e) => (
        (0, s.assertIsHexString)(e), BigInt((0, s.add0x)(e))
      );
    },
    91652: (e, t) => {
      "use strict";
    ...
    64570: (e, t, r) => {
      ...
      const n = r(25671),
        s = r(11446),
        i = r(68945);
      (t.VersionStruct = (0, s.refine)(
        (0, s.string)(),
        "Version",
        (e) => null !== (0, n.valid)(e) || `Expected SemVer version, got "${e}"`
      )),
        (t.VersionRangeStruct = (0, s.refine)(
          (0, s.string)(),
          "Version range",
          (e) =>
        ...
        (t.isValidSemVerVersion = function (e) {
          return (0, s.is)(e, t.VersionStruct);
        }),
        (t.isValidSemVerRange = function (e) {
          return (0, s.is)(e, t.VersionRangeStruct);
        }),
        (t.assertIsSemVerVersion = function (e) {
          (0, i.assertStruct)(e, t.VersionStruct);
        }),
        (t.assertIsSemVerRange = function (e) {
          (0, i.assertStruct)(e, t.VersionRangeStruct);
        }),
    ...
    24873: (e) => {
      ...
      e.exports = async function (e) {
        let { provider: s, fromBlock: i, toBlock: o } = e;
        i || (i = o);
        const a = t(i),
          c = t(o),
          l = Array(c - a + 1)
    ...
    86859: (e, t, r) => {
      const n = r(27203).eu,
        { createAsyncMiddleware: s, createScaffoldMiddleware: i } = r(80465),
        o = r(55076),
        a = r(57697),
        c = r(83582),
        { intToHex: l, hexToInt: u } = r(66483);
      ...
      e.exports = function (e) {
        ...
        const g = new n(),
          ...
          _ = i({
            ...
            eth_uninstallFilter: m(h(S)),
            eth_getFilterChanges: m(h(E)),
            eth_getFilterLogs: m(h(k)),
          }),
          b = async (e) => {
            let { oldBlock: t, newBlock: r } = e;
        ...
        function R(e) {
          ...
          0 === r && n > 0
            ? t.on("sync", b)
            : r > 0 && 0 === n && t.removeListener("sync", b);
        }
      };
    },
    55076: (e, t, r) => {
      ...
      e.exports = class extends i {
        ...
        async initialize(e) {
          ...
          const n = l(this.params.toBlock, t),
      ...
      const t = (e, t, r, n) =>
          function () {
            for (var s = arguments.length, i = new Array(s), o = 0; o < s; o++)
              i[o] = arguments[o];
            return new (0, t.promiseModule)((s, o) => {
              t.multiArgs
                ? i.push(function () {
                    for (
                      ...
                      r[n] = arguments[n];
                    t.errorFirst ? (r[0] ? o(r) : (r.shift(), s(r))) : s(r);
                  })
                : t.errorFirst
                ? i.push((e, t) => {
                    e ? o(e) : s(t);
      ...
      e.exports = (e, n) => {
        ...
        const i = new WeakMap(),
          o = new Proxy(e, {
            apply(e, r, s) {
              const a = i.get(e);
              if (a) return Reflect.apply(a, r, s);
              const c = n.excludeMain ? e : t(e, n, o, e);
              return i.set(e, c), Reflect.apply(c, r, s);
            },
            get(e, s) {
              const a = e[s];
              if (
                !((e, t) => {
                  let s = r.get(e);
                  if ((s || ((s = {}), r.set(e, s)), t in s)) return s[t];
                  const i = (e) =>
                    ...
                    c =
                      (n.include ? n.include.some(i) : !n.exclude.some(i)) && a;
                  return (s[t] = c), c;
                })(e, s) ||
                a === Function.prototype[s]
              )
                return a;
              const c = i.get(a);
              if (c) return c;
    ...
    62343: (e, t, r) => {
      const n = r(24398).default,
        { createAsyncMiddleware: s, createScaffoldMiddleware: i } = r(80465),
        o = r(86859),
        { unsafeRandomBytes: a, incrementHexInt: c } = r(66483),
        l = r(24873);
          ...
          g = i({
            eth_subscribe: s(async function (e, n) {
              ...
              function g(e) {
                ...
                return {
                  type: s,
                  destroy: async () => await h.uninstallFilter(r.idHex),
                };
              }
            }),
      ...
      e.exports = class extends n {
        ...
        async update(e) {
          ...
          const r = t,
            ...
            a = [];
          for (const s of o) a.push(...s.transactions);
          this.addResults(a);
        }
      };
    },
    49999: (e, t, r) => {
      ...
      (e.exports = i),
        ...
        (i.prototype.getBlockTransactionCountByHash = o(
          "eth_getBlockTransactionCountByHash"
        )),
        (i.prototype.getBlockTransactionCountByNumber = o(
          "eth_getBlockTransactionCountByNumber"
        )),
        (i.prototype.getUncleCountByBlockHash = o(
          "eth_getUncleCountByBlockHash"
        )),
        (i.prototype.getUncleCountByBlockNumber = o(
        ...
        (i.prototype.getTransactionByBlockHashAndIndex = o(
          "eth_getTransactionByBlockHashAndIndex"
        )),
        (i.prototype.getTransactionByBlockNumberAndIndex = o(
          "eth_getTransactionByBlockNumberAndIndex"
        )),
        (i.prototype.getTransactionReceipt = o("eth_getTransactionReceipt")),
        (i.prototype.getUncleByBlockHashAndIndex = o(
          "eth_getUncleByBlockHashAndIndex"
        )),
        (i.prototype.getUncleByBlockNumberAndIndex = o(
        ...
        (i.prototype.newPendingTransactionFilter = o(
    ...
    98340: (e, t, r) => {
      ...
      (t.JSON_RPC_SERVER_ERROR_MESSAGE = "Unspecified server error."),
        ...
        (t.serializeError = function (e) {
          let { fallbackError: t = o, shouldIncludeStack: r = !1 } =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
          var n, i;
          ...
          return r && e && h && "string" === typeof h && (l.stack = h), l;
        });
    },
    28981: (e) => {
      "use strict";
    ...
    94117: (e) => {
      ...
      function o(e, t, r, o) {
        var a;
        "undefined" === typeof o && (o = i()), c(e, "", 0, [], void 0, 0, o);
        try {
          a =
            0 === s.length
      ...
      function c(e, n, s, i, o, l, u) {
        ...
        if (((l += 1), "object" === typeof e && null !== e)) {
          for (d = 0; d < i.length; d++)
            if (i[d] === e) return void a(r, e, n, o);
          ...
          if ((i.push(e), Array.isArray(e)))
            for (d = 0; d < e.length; d++) c(e[d], d, d, i, e, l, u);
          else {
            var h = Object.keys(e);
      ...
      function d(e, s, i, o, c, u, h) {
        ...
        if (((u += 1), "object" === typeof e && null !== e)) {
          for (f = 0; f < o.length; f++)
            if (o[f] === e) return void a(r, e, s, c);
          try {
          ...
          if ((o.push(e), Array.isArray(e)))
            for (f = 0; f < e.length; f++) d(e[f], f, f, o, e, u, h);
          else {
            var p = {},
              g = Object.keys(e).sort(l);
            for (f = 0; f < g.length; f++) {
              var m = g[f];
              d(e[m], m, f, o, e, u, h), (p[m] = e[m]);
            }
      ...
      class o extends s.default {
        ...
        asMiddleware() {
          return async (e, t, r, n) => {
            try {
              const [s, i, a] = await o._runAllMiddleware(
                e,
                t,
                this._middleware
              );
              return i
                ? (await o._runReturnHandlers(a), n(s))
                : r(async (e) => {
                    try {
        ...
        async _handle(e, t) {
          if (!e || Array.isArray(e) || "object" !== typeof e) {
            const r = new i.EthereumRpcError(
              i.errorCodes.rpc.invalidRequest,
          ...
          return (
            s && (delete n.result, n.error || (n.error = i.serializeError(s))),
            t(s, n)
          );
        }
        async _processRequest(e, t) {
          ...
          if (
            (o._checkForCompletion(e, t, n), await o._runReturnHandlers(s), r)
          )
            throw r;
        }
        static async _runAllMiddleware(e, t, r) {
          ...
          let s = null,
            i = !1;
          for (const a of r)
            if ((([s, i] = await o._runMiddleware(e, t, a, n)), i)) break;
        ...
        static _runMiddleware(e, t, r, n) {
          return new Promise((s) => {
            const o = (e) => {
                const r = e || t.error;
                r && (t.error = i.serializeError(r)), s([r, !0]);
              },
              c = (r) => {
                t.error
                  ? o(t.error)
      ...
      e.exports = function (e, c) {
        ...
        if ("number" === l && isFinite(e))
          return c.long
            ? (function (e) {
                var i = Math.abs(e);
                if (i >= s) return a(e, i, s, "day");
                if (i >= n) return a(e, i, n, "hour");
                if (i >= r) return a(e, i, r, "minute");
    ...
    84746: (e, t, r) => {
      ...
      function M(e, t, r, n, s, i, o, a, c, l, u) {
        var d,
          h,
          f,
          p,
          ...
          b = (n && n.__k) || m,
          y = t.length;
        for (r.__d = c, L(r, t, b), c = r.__d, d = 0; d < y; d++)
          null != (f = r.__k[d]) &&
            ((h = -1 === f.__i ? g : b[f.__i] || g),
            (f.__i = d),
            D(e, f, h, s, i, o, a, c, l, u),
            (p = f.__e),
            f.ref &&
              h.ref != f.ref &&
              (h.ref && U(h.ref, null, f), u.push(f.ref, f.__c || p, f)),
            null == _ && null != p && (_ = p),
      ...
      function L(e, t, r) {
        var n,
          ...
          d = 0;
        for (e.__k = [], n = 0; n < c; n++)
          null != (s = t[n]) && "boolean" != typeof s && "function" != typeof s
            ? ((o = n + d),
              ((s = e.__k[n] =
                "string" == typeof s ||
                "number" == typeof s ||
              ...
              (i = null),
              -1 !== (a = s.__i = P(s, r, o, u)) &&
                (u--, (i = r[a]) && (i.__u |= 131072)),
              null == i || null === i.__v
                ? (-1 == a && d--,
                  "function" != typeof s.type && (s.__u |= 65536))
                : a !== o &&
                  (a == o - 1
                    ? d--
                    : a == o + 1
      ...
      function O(e, t, r) {
        ...
        if ("function" == typeof e.type) {
          for (n = e.__k, s = 0; n && s < n.length; s++)
            n[s] && ((n[s].__ = e), (t = O(n[s], t, r)));
          return t;
        }
        e.__e != t &&
          (t && e.type && !r.contains(t) && (t = R(e)),
      ...
      function P(e, t, r, n) {
        ...
        if (
          null === c ||
          (c && s == c.key && i === c.type && 0 == (131072 & c.__u))
        )
          return r;
        if (
          ("function" != typeof i || i === S || s) &&
          n > (null != c && 0 == (131072 & c.__u) ? 1 : 0)
        )
          for (; o >= 0 || a < t.length; ) {
            if (o >= 0) {
              if (
        ...
        e: if ("style" === t)
          ...
          (i = t !== (t = t.replace(/(PointerCapture)$|Capture$/i, "$1"))),
            ...
            r
              ? n
                ? (r.u = n.u)
                : ((r.u = d), e.addEventListener(t, i ? f : h, i))
              : e.removeEventListener(t, i ? f : h, i);
        else {
      ...
      function B(e) {
        return function (t) {
          if (this.l) {
            ...
            return (
              s.event && (t = s.event(t)),
              "handleEvent" in r ? r.handleEvent(t) : r(t)
            );
          }
        };
      }

      function D(e, t, r, n, i, o, a, c, l, u) {
        var d,
          h,
          f,
          p,
        ...
        e: if ("function" == typeof O)
          try {
            if (
              ...
              (E = (d = O.contextType) && n[d.__c]),
              (k = d ? (E ? E.props.value : d.__) : n),
              r.__c
                ? (_ = (h = t.__c = r.__c).__ = h.__E)
                : (w
                    ? (t.__c = h = new O(v, k))
                    : ((t.__c = h = new C(v, k)),
                      (h.constructor = O),
              ...
              w &&
                ...
                (h.__s == h.state && (h.__s = y({}, h.__s)),
                y(h.__s, O.getDerivedStateFromProps(v, h.__s))),
              (p = h.props),
              (g = h.state),
              (h.__v = t),
              f)
              ...
              if (
                ...
                !h.__e &&
                  ((null != h.shouldComponentUpdate &&
                    !1 === h.shouldComponentUpdate(v, h.__s, k)) ||
                    t.__v === r.__v))
              ) {
                for (
                  t.__v !== r.__v &&
              ...
              null != h.componentWillUpdate &&
                h.componentWillUpdate(v, h.__s, k),
                w &&
          ...
          null == o && t.__v === r.__v
            ...
            : (t.__e = $(r.__e, t, r, n, i, o, a, l, u));
        (d = s.diffed) && d(t);
      }

      function F(e, t, r) {
        t.__d = void 0;
        for (var n = 0; n < r.length; n++) U(r[n], r[++n], r[++n]);
        s.__c && s.__c(t, e),
          e.some(function (t) {
            try {
              (e = t.__h),
      ...
      function $(e, t, r, i, o, a, c, l, u) {
        ...
        if (null == e) {
          ...
          (e = document.createElementNS(o, k, E.is && E)),
            l && (s.__m && s.__m(t, a), (l = !1)),
            (a = null);
        }
        if (null === k) w === E || (l && e.data === E) || (e.data = E);
        else {
          if (
          ...
          for (d in w)
            if (((m = w[d]), "children" == d));
            else if ("dangerouslySetInnerHTML" == d) f = m;
            else if (!(d in E)) {
              if (
      ...
      function H(e, t, r) {
        ...
        if (
          ...
          (n = e.ref) && ((n.current && n.current !== e.__e) || U(n, null, t)),
          null != (n = e.__c))
        ) {
        ...
        if ((n = e.__k))
          for (i = 0; i < n.length; i++)
            n[i] && H(n[i], t, r || "function" != typeof e.type);
        r || v(e.__e), (e.__c = e.__ = e.__e = e.__d = void 0);
      }
      ...
      function z(e, t, r) {
        ...
        return (
          ...
          E(e.type, c, s || e.key, i || e.ref, null)
        );
      }
    ...
    1392: (e, t, r) => {
      ...
      function v(e, t) {
        var r = _(n++, 3);
        !u.__s && T(r.__H, t) && ((r.__ = e), (r.i = t), s.__H.__h.push(r));
      }

      function w(e, t) {
        var r = _(n++, 4);
        !u.__s && T(r.__H, t) && ((r.__ = e), (r.i = t), s.__h.push(r));
      }
      ...
      function M() {
        for (var e; (e = l.shift()); )
          if (e.__P && e.__H)
            try {
              e.__H.__h.forEach(N), e.__H.__h.forEach(P), (e.__H.__h = []);
            } catch (n) {
        ...
        (u.__r = function (e) {
          ...
          t &&
            (i === s
              ...
              : (t.__h.forEach(N), t.__h.forEach(P), (t.__h = []), (n = 0))),
            (i = s);
        }),
        (u.diffed = function (e) {
          f && f(e);
    ...
    47544: (e, t, r) => {
      ...
      for (var o = n(i.prototype), a = 0; a < o.length; a++) {
        var c = o[a];
        l.prototype[c] || (l.prototype[c] = i.prototype[c]);
      }
    ...
    93230: (e, t, r) => {
      ...
      function k(e, t, s) {
        (n = n || r(47544)),
          ...
          (this.highWaterMark = g(this, e, "readableHighWaterMark", s)),
          (this.buffer = new f()),
          (this.length = 0),
          (this.pipes = null),
          (this.pipesCount = 0),
      ...
      function S(e) {
        if (((n = n || r(47544)), !(this instanceof S))) return new S(e);
      ...
      function C(e, t, r, n, s) {
        ...
        if (null === t)
          ...
          if (
            ...
            l.endEmitted ? w(e, new v()) : R(e, l, t, !0);
          else if (l.ended) w(e, new b());
          else {
            if (l.destroyed) return !1;
            (l.reading = !1),
              l.decoder && !r
                ? ((t = l.decoder.write(t)),
                  l.objectMode || 0 !== t.length ? R(e, l, t, !1) : L(e, l))
                : R(e, l, t, !1);
          }
        else n || ((l.reading = !1), L(e, l));
      ...
      (S.prototype.read = function (e) {
            ...
            "data" === e
              ...
              : "readable" === e &&
                (n.endEmitted ||
                  ...
                  n.length ? A(this) : n.reading || process.nextTick(P, this))),
            r
          );
        }),
        ...
        (S.prototype.resume = function () {
          ...
          return (
            e.flowing ||
              ...
              (function (e, t) {
                t.resumeScheduled ||
                  ((t.resumeScheduled = !0), process.nextTick(T, e, t));
              })(this, e)),
            (e.paused = !1),
            this
          );
        ...
        "function" === typeof Symbol &&
          (S.prototype[Symbol.asyncIterator] = function () {
            return void 0 === d && (d = r(79733)), d(this);
          }),
        ...
        "function" === typeof Symbol &&
          (S.from = function (e, t) {
            return void 0 === h && (h = r(9951)), h(S, e, t);
          });
    },
    15624: (e, t, r) => {
      "use strict";
    ...
    34306: (e, t, r) => {
      ...
      var l,
        ...
        y = h.ERR_STREAM_WRITE_AFTER_END,
      ...
      function k(e, t, i) {
        (s = s || r(47544)),
          (e = e || {}),
          "boolean" !== typeof i && (i = t instanceof s),
          (this.objectMode = !!e.objectMode),
          ...
          (this.onwrite = function (e) {
            !(function (e, t) {
              ...
              if (
                ...
                var i = x(r) || e.destroyed;
                i ||
                  r.corked ||
                  r.bufferProcessing ||
                  !r.bufferedRequest ||
                  I(e, r),
                  n ? process.nextTick(R, e, r, i, s) : R(e, r, i, s);
              }
            })(t, e);
          }),
          (this.writecb = null),
      ...
      function S(e) {
        var t = this instanceof (s = s || r(47544));
        ...
        if (e._writev && r && r.next) {
          ...
          for (; r; ) {
            var l = r.chunk,
              ...
              d = r.callback;
            if (
              (C(e, t, !1, t.objectMode ? 1 : l.length, l, u, d),
              (r = r.next),
      ...
      r(61596)(S, o),
        ...
        (S.prototype.write = function (e, t, r) {
          var n,
            ...
            i = !1,
            o = !s.objectMode && ((n = e), a.isBuffer(n) || n instanceof c);
          return (
            o &&
              !a.isBuffer(e) &&
              (e = (function (e) {
              ...
              : (o ||
                  (function (e, t, r, n) {
                    ...
                    return (
                      ...
                      !s || (w(e, s), process.nextTick(n, s), !1)
                    );
                  })(this, s, e, r)) &&
                (s.pendingcb++,
                (i = (function (e, t, r, n, s, i) {
                  if (!r) {
                    var o = (function (e, t, r) {
                      e.objectMode ||
                        !1 === e.decodeStrings ||
          ...
          (r = [
            ...
            },
            {
              ...
              value: function (e) {
                ...
                for (
                  var t, r, n, s = c.allocUnsafe(e >>> 0), i = this.head, o = 0;
                  i;
    ...
    38172: (e, t, r) => {
      "use strict";
      var n = r(97614).F.ERR_STREAM_PREMATURE_CLOSE;
      ...
      e.exports = function () {
        ...
        var h = t.map(function (e, s) {
          ...
          return (function (e, t, s, i) {
            ...
            u || (u = e), e && h.forEach(c), i || (h.forEach(c), d(u));
          });
        });
        return t.reduce(l);
      };
    ...
    2809: (e, t, r) => {
      "use strict";
      var n = r(97614).F.ERR_INVALID_OPT_VALUE;
      e.exports = {
    ...
    44687: (e, t, r) => {
      e.exports = r(28981).EventEmitter;
    },
    44833: (e, t, r) => {
      ((t = e.exports = r(93230)).Stream = t),
        (t.Readable = t),
        (t.Writable = r(34306)),
        (t.Duplex = r(47544)),
        (t.Transform = r(15624)),
        (t.PassThrough = r(32666)),
        (t.finished = r(38172)),
        (t.pipeline = r(43648));
    },
    16047: (e, t, r) => {
    ...
    9605: (e, t, r) => {
      ...
      class s {
        ...
        parseRange(e) {
          ...
          const n = this.options.loose,
            s = n ? u[d.HYPHENRANGELOOSE] : u[d.HYPHENRANGE];
          (e = e.replace(s, M(this.options.includePrerelease))),
            c("hyphen replace", e),
      ...
      const i = new (r(24252))(),
        ...
        { FLAG_INCLUDE_PRERELEASE: g, FLAG_LOOSE: m } = r(26020),
        _ = (e) => "<0.0.0-0" === e.value,
        b = (e) => "" === e.value,
        y = (e, t) => {
          let r = !0;
        ...
        x = (e, t) => (
          c("replaceStars", e, t), e.trim().replace(u[d.STAR], "")
        ),
        A = (e, t) => (
          c("replaceGTE0", e, t),
          e.trim().replace(u[t.includePrerelease ? d.GTE0PRE : d.GTE0], "")
        ),
        M = (e) => (t, r, n, s, i, o, a, c, l, u, d, h) =>
          `${(r = w(n)
            ? ""
            : w(s)
            ? `>=${n}.0.0${e ? "-0" : ""}`
    ...
    55198: (e, t, r) => {
      const n = r(78738),
        { MAX_LENGTH: s, MAX_SAFE_INTEGER: i } = r(26020),
        { safeRe: o, t: a } = r(47768),
        c = r(1565),
        { compareIdentifiers: l } = r(84493);
      class u {
        constructor(e, t) {
    ...
    86072: (e, t, r) => {
      ...
      e.exports = (e, t) => {
        ...
        if ((t = t || {}).rtl) {
          ...
          for (
            ;
            (s = n.exec(e)) && (!r || r.index + r[0].length !== e.length);
    ...
    47768: (e, t, r) => {
      ...
      p("NUMERICIDENTIFIER", "0|[1-9]\\d*"),
        ...
        p(
          "MAINVERSION",
          `(${l[u.NUMERICIDENTIFIER]})\\.(${l[u.NUMERICIDENTIFIER]})\\.(${
            l[u.NUMERICIDENTIFIER]
          })`
        ),
        p(
          "MAINVERSIONLOOSE",
        ...
        p(
          ...
          `(?:${l[u.NUMERICIDENTIFIER]}|${l[u.NONNUMERICIDENTIFIER]})`
        ),
        p(
          "PRERELEASEIDENTIFIERLOOSE",
          `(?:${l[u.NUMERICIDENTIFIERLOOSE]}|${l[u.NONNUMERICIDENTIFIER]})`
        ),
        p(
          "PRERELEASE",
        ...
        p(
          "BUILD",
          `(?:\\+(${l[u.BUILDIDENTIFIER]}(?:\\.${l[u.BUILDIDENTIFIER]})*))`
        ),
        p(
          "FULLPLAIN",
          `v?${l[u.MAINVERSION]}${l[u.PRERELEASE]}?${l[u.BUILD]}?`
        ),
        p("FULL", `^${l[u.FULLPLAIN]}$`),
        p(
          "LOOSEPLAIN",
          `[v=\\s]*${l[u.MAINVERSIONLOOSE]}${l[u.PRERELEASELOOSE]}?${
            l[u.BUILD]
          }?`
        ),
        ...
        p(
          ...
          })(?:\\.(${l[u.XRANGEIDENTIFIER]})(?:${l[u.PRERELEASE]})?${
            l[u.BUILD]
          }?)?)?`
        ),
        p(
          ...
          })(?:\\.(${l[u.XRANGEIDENTIFIERLOOSE]})(?:${l[u.PRERELEASELOOSE]})?${
            l[u.BUILD]
          }?)?)?`
        ),
        ...
        p("COERCERTLFULL", l[u.COERCEFULL], !0),
        p("LONETILDE", "(?:~>?)"),
        ...
        p(
          "COMPARATORTRIM",
          `(\\s*)${l[u.GTLT]}\\s*(${l[u.LOOSEPLAIN]}|${l[u.XRANGEPLAIN]})`,
          !0
        ),
        (t.comparatorTrimReplace = "$1$2$3"),
        p(
          "HYPHENRANGE",
          `^\\s*(${l[u.XRANGEPLAIN]})\\s+-\\s+(${l[u.XRANGEPLAIN]})\\s*$`
        ),
        p(
          "HYPHENRANGELOOSE",
          `^\\s*(${l[u.XRANGEPLAINLOOSE]})\\s+-\\s+(${
            l[u.XRANGEPLAINLOOSE]
          })\\s*$`
        ),
        p("STAR", "(<|>)?=?\\s*\\*"),
        p("GTE0", "^\\s*>=\\s*0\\.0\\.0\\s*$"),
    ...
    90201: (e, t, r) => {
      ...
      e.exports = (e, t, r, h) => {
        let f, p, g, m, _;
        switch (((e = new n(e, h)), (t = new o(t, h)), r)) {
          case ">":
            (f = c), (p = u), (g = l), (m = ">"), (_ = ">=");
            break;
          case "<":
    ...
    2566: (e, t, r) => {
      const n = r(9605),
        ...
        u = (e, t, r) => {
          ...
          if (s && u) {
            if (((f = a(s.semver, u.semver, r)), f > 0)) return null;
            if (0 === f && (">=" !== s.operator || "<=" !== u.operator))
              return null;
          }
          for (const i of n) {
            if (s && !o(i, String(s), r)) return null;
            if (u && !o(i, String(u), r)) return null;
            for (const e of t) if (!o(i, String(e), r)) return !1;
            return !0;
          }
          let b =
            ...
            if (u)
              if (
                (b &&
                  i.semver.prerelease &&
                  i.semver.prerelease.length &&
                  i.semver.major === b.major &&
                  i.semver.minor === b.minor &&
                  i.semver.patch === b.patch &&
                  (b = !1),
                "<" === i.operator || "<=" === i.operator)
              ) {
                if (((g = h(u, i, r)), g === i && g !== u)) return !1;
              } else if ("<=" === u.operator && !o(u.semver, String(i), r))
                return !1;
            if (!i.operator && (u || s) && 0 !== f) return !1;
          }
          return (
            !(s && m && !u && 0 !== f) && !(u && _ && !s && 0 !== f) && !y && !b
          );
        },
        d = (e, t, r) => {
          if (!e) return t;
      ...
      n(c, s),
        ...
        (c.prototype._update = function (e) {
          ...
          (this._al = (this._al + v) | 0),
            ...
            (this._fh = (this._fh + c + _(this._fl, C)) | 0),
            (this._gh = (this._gh + b + _(this._gl, R)) | 0),
    ...
    11446: (e, t, r) => {
      ...
      function l(e, t) {
        ...
        return (function* () {
          ...
          for (const s of t.validator(e, c))
            (s.explanation = r.message), (u = "not_valid"), yield [s, void 0];
      ...
      function v(e) {
        ...
        return new u({
          ...
          *entries(r, n) {
            var s;
            (null !== (s = t) && void 0 !== s) || (t = e()),
              yield* t.entries(r, n);
          },
          validator(r, n) {
            var s;
            return (
              (null !== (s = t) && void 0 !== s) || (t = e()), t.validator(r, n)
            );
          },
          coercer(r, n) {
            var s;
            return (
              (null !== (s = t) && void 0 !== s) || (t = e()), t.coercer(r, n)
            );
          },
          refiner(r, n) {
            var s;
            return (
              (null !== (s = t) && void 0 !== s) || (t = e()), t.refiner(r, n)
            );
          },
        });
      }
      ...
      function E(e) {
        ...
        for (const n in r) r[n] = U(r[n]);
        return t && "type" === e.type ? J(r) : $(r);
      }
        ...
        return new u({
          ...
          *entries(n) {
            if (e && s(n)) {
              ...
              for (const r of t) s.delete(r), yield [r, n[r], e[r]];
              for (const e of s) yield [e, n[e], r];
            }
          },
      ...
      function J(e) {
        ...
        return new u({
          ...
          schema: e,
          *entries(r) {
            if (s(r)) for (const n of t) yield [n, r[n], e[n]];
          },
          validator: (e) => s(e) || `Expected an object, but received: ${o(e)}`,
          coercer: (e) =>
            s(e)
      ...
      function K(e, t, r) {
        return new u({
          ...e,
          coercer: (n, s) =>
            p(n, t) ? e.coercer(r(n, s), s) : e.coercer(n, s),
        });
      }
      ...
      function l(e, t, r, n, s, i) {
        ...
        for (
          ...
          if ("accessor" === c) {
            ...
            (a = o(m.get)) && (d.get = a),
              (a = o(m.set)) && (d.set = a),
              (a = o(m.init)) && s.unshift(a);
          } else (a = o(m)) && ("field" === c ? s.unshift(a) : (d[l] = a));
        }
            ...
            try {
              ...
              if (r.dispose) {
                ...
                if (r.async)
                  return (
                    (n |= 2),
                    Promise.resolve(i).then(s, function (e) {
                      return t(e), s();
                    })
                  );
              } else n |= 1;
